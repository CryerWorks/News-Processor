...
def merge_story_groups(input_csv, output_csv="merged_stories_poland.csv", output_excel="merged_stories_poland.xlsx"):
    """
...
def main():
    input_csv = "chained_news_poland.csv"  # Ensure this file exists
