...
def save_chained_articles(chained_articles, output_filename="chained_news_finland.csv"):
    """
...
def main():
    ...
    input_csv = "extracted_news_finland.csv"
    ...
    # Save results
    save_chained_articles(chained_articles, "chained_news_finland.csv")
